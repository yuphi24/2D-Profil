...
function getAboutSelectedData(val, chartContext, config) {
  ...
  console.log("coordinates", w.config.series[seriesIndex].data[dataPointIndex]);
  // coordinates.value = w.config.series[seriesIndex].data[dataPointIndex].geometry.coordinates;
  env.value =
